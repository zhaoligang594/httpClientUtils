 ...
 * @Author :zlg
 * @Description :
 * @Date : Create in 2017/10/18  下午4:26
 * @Modified By :
 */

@Slf4j
@Service("springHttpClientUtil")
public class SpringHttpClientUtil {
    ...
    public String doGet(String url) throws URISyntaxException,
        ...
        return doGet(url, HttpDataEntity.createHttpDataEntity());
    }
     ...
     *
     * @param url
     * @param httpDataEntity 请求中的参数
     * @return 请求到的内容
     * @throws URISyntaxException
     * @throws IOException
     * @throws ClientProtocolException
     */
    public String doGet(String url, HttpDataEntity httpDataEntity)
            throws URISyntaxException, ClientProtocolException, IOException {
        // 定义请求的参数
        URI uri = null;
        Map<String, Object> params = httpDataEntity.getMap();
        if (params != null) {
     ...
     * @throws IOException
     */
    public String doPost(String url, HttpDataEntity httpDataEntity)
            throws URISyntaxException, ClientProtocolException, IOException {
        // 设置post参数
    ...
    public String doPost(String url) throws URISyntaxException,
            ClientProtocolException, IOException {
        return doPost(url, HttpDataEntity.createHttpDataEntity());
    }
}
